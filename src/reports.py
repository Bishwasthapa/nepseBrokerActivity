...
<section class="view" id="view-momentum">
  ...
  <label title="Number of recent trading sessions to measure (e.g. 5 ≈ 1 week, 20 ≈ 1 month). Must be shorter than Baseline Window.">Std Recent<input id="mom-short" type="number" value="5" min="1" max="50"></label>
  <label title="Longer baseline reference window (e.g. 22 ≈ 1 month, 66 ≈ 1 quarter) to compare against.">Std Baseline<input id="mom-base" type="number" value="22" min="1" max="100"></label>
  <label title="Fast recent window for early warning radar (default 3).">Fast Recent<input id="mom-fast-short" type="number" value="3" min="1" max="10"></label>
  <label title="Fast baseline window for early warning radar (default 10).">Fast Baseline<input id="mom-fast-base" type="number" value="10" min="1" max="50"></label>
  <label title="Minimum baseline average turnover (in NRS) to qualify for early warning (filters out dry microcaps).">Min Turnover<input id="mom-fast-min" type="number" value="5000000" step="100000"></label>
