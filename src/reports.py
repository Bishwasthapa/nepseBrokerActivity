...
<section class="view" id="view-momentum">
  ...
  <div class="block" id="radar-wrap">
    <h3>&#x1F6A8; Institutional Accumulation Radar <span class="badge stealth" style="margin-left:8px;font-size:12px;">Early Warning</span></h3>
    ...
    <div class="tips" style="margin-bottom:10px;">
      <span class="tag"><b>Factor 1 &mdash; Fast Heat (3v10):</b> 3-day avg turnover &ge; 1.20&times; vs 10-day baseline</span>
      <span class="tag"><b>Factor 2 &mdash; Acceleration:</b> 3v10 ratio &gt; 5v22 ratio (volume intensifying faster than trend)</span>
